...
class DisplaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create display" do
    assert_difference('Display.count') do
      post displays_url, params: { display: { active: @display.active, name: @display.name, order: @display.order, resolution: @display.resolution } }
    end
  ...
  test "should update display" do
    patch display_url(@display), params: { display: { active: @display.active, name: @display.name, order: @display.order, resolution: @display.resolution } }
